...
<body>
	...
	<article>
		...
		<section>
			<h2 align="center">SOAL NOMOR 6</h2>
			<?php
			...
			<form method="post">
				<?php 
				//<input type="hidden" name="kunci" value="bahasa natural, struktur indonesia dan struktur inggris, flowchart, pseudo code">
				?>
				<?php
					if($bacasoal['soal6'] != null) {
				?>
				<label>
					6. Sebutkan 3 jenis Algoritma….  <br>
					<textarea name="soal6" placeholder="Isikan jawaban anda..."><?php echo $bacasoal['soal6']; ?></textarea>
				</label>
				<?php						
					} else {
				?>
				<label>
					6. Sebutkan 3 jenis Algoritma….  <br>
					<textarea name="soal6" placeholder="Isikan jawaban anda..."></textarea>
				</label>
				<?php
					} 
				?>
			...
			<?php
				...
				if(isset($_POST['btnsoal1'])) {
					if(!empty($_POST['soal6'])) {
						$sqlupdate=mysqli_query($koneksi,"UPDATE tbl_soal SET soal6='$_POST[soal6]' WHERE id_peserta='$datapeserta[id]'");
						header('location:soal7.php');
					} else {
