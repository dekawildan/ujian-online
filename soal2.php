...
<body>
	...
	<article>
		...
		<section>
			<h2 align="center">SOAL NOMOR 2</h2>
			<?php
			...
			<form method="post">
				...
				?>
				<label>
					2. Syarat berfikir logis adalah….  <br>
			...
			<?php
				...
				if(isset($_POST['btnsoal1'])) {
					if(!empty($_POST['nomor1'])) {
						$sqlupdate=mysqli_query($koneksi,"UPDATE tbl_soal SET soal2='$_POST[nomor1]' WHERE id_peserta='$datapeserta[id]'");
