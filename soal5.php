...
<body>
	...
	<article>
		...
		<section>
			<h2 align="center">SOAL NOMOR 5</h2>
			<?php
			...
			<form method="post">
				...
				?>
				<label>
					5. Salah satu cara untuk memvisualkan proses berpikir adalah dengan menggunakan….  <br>
					a. <input type="radio" name="nomor1" value="A" checked="checked"> Peta minda<br>
				</label>
				<label>
					b. <input type="radio" name="nomor1" value="B"> Peta logika <br>
				</label>
				<label>
					c. <input type="radio" name="nomor1" value="C"> Peta alam<br>
				</label>
				<label>
					d. <input type="radio" name="nomor1" value="D"> Atlas<br>
				</label>
				<label>
					e. <input type="radio" name="nomor1" value="E"> Peta dunia<br>
				</label>
				<?php						
					} else if($bacasoal['soal5'] == 'B') {
				?>
				<label>
					5. Salah satu cara untuk memvisualkan proses berpikir adalah dengan menggunakan….  <br>
					a. <input type="radio" name="nomor1" value="A"> Peta minda<br>
				</label>
				<label>
					b. <input type="radio" name="nomor1" value="B" checked="checked"> Peta logika <br>
				</label>
				<label>
					c. <input type="radio" name="nomor1" value="C"> Peta alam<br>
				</label>
				...
				<label>
					c. <input type="radio" name="nomor1" value="C" checked="checked"> Peta alam<br>
				</label>
				<label>
					d. <input type="radio" name="nomor1" value="D"> Atlas<br>
				</label>
				...
				<label>
					d. <input type="radio" name="nomor1" value="D" checked="checked"> Atlas<br>
				</label>
				<label>
					e. <input type="radio" name="nomor1" value="E"> Peta dunia<br>
				</label>
				<?php
					}  else if($bacasoal['soal5'] == 'E') {
				?>
				<label>
					5. Salah satu cara untuk memvisualkan proses berpikir adalah dengan menggunakan….  <br>
					a. <input type="radio" name="nomor1" value="A"> Peta minda<br>
				...
				<label>
					e. <input type="radio" name="nomor1" value="E" checked="checked"> Peta dunia<br>
				</label>
				<?php
					}  else  {
				?>
			...
			<?php
				...
				if(isset($_POST['btnsoal1'])) {
					if(!empty($_POST['nomor1'])) {
						$sqlupdate=mysqli_query($koneksi,"UPDATE tbl_soal SET soal5='$_POST[nomor1]' WHERE id_peserta='$datapeserta[id]'");
